...
- `/parent/marketing-automation/.planning/spec-kit/plans/roadmaps/publisher-refactor-roadmap.md`
- `/parent/marketing-automation/.planning/spec-kit/plans/sprints/`
- `/parent/marketing-automation/.planning/spec-kit/plans/tasks/`
- `/parent/marketing-automation/.planning/spec-kit/plans/tasks/publisher-refactor-constraints-checklist.md`
...
Source of truth:
- .planning/spec-kit/plans/roadmaps/publisher-refactor-roadmap.md
- .planning/spec-kit/plans/sprints/
- .planning/spec-kit/plans/tasks/
- .planning/spec-kit/plans/tasks/publisher-refactor-constraints-checklist.md
- .planning/spec-kit/plans/tasks/session-handover.md
...
7) Update `.planning/spec-kit/plans/tasks/session-handover.md` before finishing.
8) End with:
   - what changed,
...
### Current phase
- Phase: `5`
- Sprint file: `/parent/marketing-automation/.planning/spec-kit/plans/sprints/publisher-refactor-sprint-5-hardening.md`
- Task file: `/parent/marketing-automation/.planning/spec-kit/plans/tasks/publisher-refactor-phase-5-hardening-tasks.md`
...
- Closed remaining checklist items in `/parent/marketing-automation/.planning/spec-kit/plans/tasks/publisher-refactor-phase-5-hardening-tasks.md`:
  - regression guards,
  - validation gates,
