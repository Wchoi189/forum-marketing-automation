...
export async function validateRuntimeContracts(): Promise<void> {
  ...
  const envPayload = {
    ...
    OLLAMA_REQUEST_TIMEOUT_MS: ENV.OLLAMA_REQUEST_TIMEOUT_MS,
    OLLAMA_MAX_RETRIES: ENV.OLLAMA_MAX_RETRIES,
    OLLAMA_MAX_IMAGE_MEGAPIXELS: ENV.OLLAMA_MAX_IMAGE_MEGAPIXELS,
    OLLAMA_CONCURRENCY_MAX: ENV.OLLAMA_CONCURRENCY_MAX
  };
